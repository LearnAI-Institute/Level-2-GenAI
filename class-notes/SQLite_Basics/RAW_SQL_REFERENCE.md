# 📚 Raw SQL — Full Reference Guide (Optional Reading)

> ## ⚠️ This is a REFERENCE document — not required for class.
>
> In our class we use **SQLModel** (no SQL queries to write).
> But sometimes you might want to **peek under the hood** and see how raw SQL works.
> This guide is for those curious moments.
>
> **When this is useful:**
> - 🔍 Debugging when SQLModel does something unexpected
> - 💼 Future jobs/projects that use raw SQL
> - 🎓 Interview preparation
> - 🧠 Understanding what your ORM is doing for you
>
> **For your class assignments — use the main `README.md` (SQLModel approach).**

---

# SQLite — Raw SQL Deep Dive (Reference)

> Step-by-step coverage of raw SQL operations with the `sqlite3` module.
> Same beginner-friendly style as the rest of the class.
